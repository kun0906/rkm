	...
	for dataset_name in dataset_names:
		if dataset_name == '3GAUSSIANS':
			...
			if case == 'diff_outliers':
				...
				"""
				n_clusters = 2
				for mu in [-5, -12.5, -25, -50, -100, -200]:
					detail = f'r:0.1|mu:{mu},0|cov:0.1,0.1|diff_outliers'
...
if __name__ == '__main__':
	# For debugging.
	main(N_REPEATS=1, OVERWRITE=True, IS_DEBUG=True, VERBOSE=1, CASE='constructed_3gaussians')
	# Call collect_results.sh to get the plot
	#./collect_results.sh
	exit(0)

	st = time.time()
	for CASE in ['diff_outliers', 'mixed_clusters', 'constructed_3gaussians']:  # , 'mixed_clusters', 'diff_outliers',
		try:
