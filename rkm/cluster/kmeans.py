	...
	def fit(self, X, y=None):
		...
		for iteration in range(0, self.max_iter+1):
			...
			if iteration == 0:
				...
				self.history.append({'iteration': iteration, 'centroids': self.centroids,
			...
			# new_centroids = copy.deepcopy(self.centroids)   # if the centroid has no data point, then use the previous centroid.
