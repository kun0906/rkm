...
def tukey_median(X, random_state=42):
	u = copy.deepcopy(X)
	depths = depth_tukey(u=u, X=X, ndir=1000, threads=-1, exact=False, random_state=random_state)
...
if __name__ == '__main__':
	...
	print(res.shape, res)
	med, depth, index = tukey_median(X, random_state=random_state)
