...
def main(num_repeat=5, radius=3, noise_mean=0, noise_cov=5, prop=0.80, initial_method='omnisicent'):
    ...
    nnum_centroids_list = [5]
    # nnum_centroids_list = range(5, 30 + 1, 5)
    tot_dims =[3] #
    # tot_dims = range(5, 30 + 1, 5)

    for num_centroids in tqdm(nnum_centroids_list):
        # True labels
...
parser.add_argument("--radius", type=int, default=3)  # -1 for debugging
parser.add_argument("--nmean", type=int, default= 0)
parser.add_argument("--ncov", type=int, default=25)
parser.add_argument("--prop", type=float, default=0.4)
...
if __name__ == '__main__':
    ...
    print(args)
    # different dimensions or n_centroids
