        ...
        for i in range(num_repeat):
            ...
            if True:
                ...
                for idx in range(0, len(points), true_single_cluster_size):
                    ...
                    centroids[j] = np.mean(points[idx:idx + true_single_cluster_size], axis=0)
                    j += 1
