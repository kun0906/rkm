...
for num_centroids in range(4, 9, 9):
    ...
    for dim in tqdm(tot_dims):
        ...
        for i in range(num_repeat):
            ...
            lloydL1_centroids, lloydL1_labels = k_medians_l2(points, centroids_input=init_centroids, k=num_centroids,
                                                        true_centroids=centroids)
            kmed_centroids, kmed_labels = k_medians_l1(points, centroids_input=init_centroids, k=num_centroids,
                                               true_centroids=centroids)
            kmeans_centroids, kmeans_labels = k_means(points, centroids_input=init_centroids, k=num_centroids,
                                                     true_centroids=centroids)
            is_sc = True
            if is_sc:
