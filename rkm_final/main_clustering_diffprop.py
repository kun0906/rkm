    ...
    for prop in tqdm(props):
        ...
        for i in range(num_repeat):
            ...
            robust_sc_lloydL1_misc.append(
                sum(robust_sc_lloydL1_labels[range(num_centroids * true_cluster_size)] != true_labels) / len(true_labels))
            ...
            robust_sc_kmeans_misc.append(
                sum(robust_sc_kmeans_labels[range(num_centroids * true_cluster_size)] != true_labels) / len(true_labels))
