...
def generate_sh():
    ...
    cnt = 0
    for n_repeats in [1000]:
        for true_cluster_size in [200]:
            init_method = 'omnisicent'
            cnt += 1
...
python3 main_clustering_diffrad_random.py --n_repeats {n_repeats} --true_cluster_size {true_cluster_size} --init_method {init_method} &> 'out/main_clustering_diffrad_{name}.txt' & 
python3 main_clustering_diffvar_random.py --n_repeats {n_repeats} --true_cluster_size {true_cluster_size} --init_method {init_method} &> 'out/main_clustering_diffvar_{name}.txt' & 
